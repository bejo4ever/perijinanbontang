...
<body onLoad="window.print()">
	...
	<table width="680px" align="center" cellpadding="0" cellspacing="0" style="padding:20px;border:2px solid black;">
		...
		<tr>
			<td colspan="2"><span style="margin-left:50px">Nomor Kendaraan</span></td>
			<td colspan="3">: <?php echo $sppl["NOMOR_KENDARAAN"]; ?></td>
		</tr>
		<tr>
			<td colspan="2"><span style="margin-left:50px">Alamat Pemilik</span></td>
			<td colspan="3">: <?php echo $sppl["ALAMAT_PEMILIK"]; ?></td>
		</tr>
		<tr>
