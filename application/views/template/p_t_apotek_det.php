...
<?php } ?>	<table>
		<caption>Data Izin Apotek</caption>
		<thead>
			<tr>
				...
				<th align="center">Nama Apotek</td>
		...
		<tbody>
			...
			?>
				<tr>
					...
					<td><?php echo $subrecord->det_apotek_jenis_nama; ?></td>
					<td><?php echo date('d-m-Y', strtotime($subrecord->det_apotek_tanggal)); ?></td>
