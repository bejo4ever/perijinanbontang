...
<body onLoad="window.print()">
	...
	<table width="680px" align="center" cellpadding="0" cellspacing="0" style="padding:20px;border:2px solid black;">
		<tr>
			...
			<td align="center" colspan="4"><h4 style="margin:0px;">BUKTI PENERIMAAN DOKUMEN IZIN USAHA JASA KONSTRUKSI</h4></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan="3">: <?php echo date('d-m-Y', strtotime($det_iujk_tanggal)); ?></td>
		</tr>
		<tr>
