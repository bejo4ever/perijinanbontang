...
<body onLoad="window.print()">
	...
	<table width="680px" align="center" cellpadding="0" cellspacing="0" style="padding:20px;border:2px solid black;">
		<tr>
			...
			<td align="center" colspan="4"><h4 style="margin:0px;">BUKTI PENERIMAAN DOKUMEN IZIN PRINSIP</h4></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan="3">: <?php echo $prinsip["NAMA_PERUSAHAAN"]; ?></td>
		</tr>
		<tr>
			<td colspan="2"><span style="margin-left:50px">Alamat</span></td>
			<td colspan="3">: <?php echo $prinsip["ALAMAT_LOKASI"]; ?></td>
		</tr>
		<tr>
			<td colspan="2"><span style="margin-left:50px">Tanggal Masuk</span></td>
			<td colspan="3">: <?php echo date('d-m-Y', strtotime($prinsip["TGL_PERMOHONAN"])); ?></td>
		</tr>
		<tr>
