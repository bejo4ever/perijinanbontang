...
<body onLoad="window.print()">
	...
	<table width="680px" align="center" cellpadding="0" cellspacing="0" style="padding:20px;border:2px solid black;">
		<tr>
			<td rowspan="5" align="center"><img src="<?php echo base_url(); ?>assets/images/logo-bontang.jpg" width="50px" height="60px"></td>
			<td align="center" colspan="4"><h4 style="margin:0px;">BUKTI PENERIMAAN DOKUMEN</h4></td>
		</tr>
		<tr>
			<td align="center" colspan="4"><h4 style="margin:0px;">IZIN PENGAMBILAN MINERAL BUKAN LOGAM DAN BATUAN</h4></td>
		</tr>
		<tr>
