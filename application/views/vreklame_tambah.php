	...
	$(function() {		
		...
		var newDiv = $(document.createElement('tr')).attr("id", 'datareklame13' + counter1);		
			newDiv.html('<td><div align="right">Jangka Waktu Pemasangan</div></td>'+
      					'<td><div align="center">:</div></td>'+
      					'<td><div align="left"><input type="text" name="jangkawaktu'+counter1+'" id="jangkawaktu'+counter1+'">'+
  ...
  <table width="100%"  border="0" cellspacing="1" cellpadding="1">
    <tr>
      <td height="25" colspan="3" style="padding:10px 0px 10px 0px; border-bottom:1px dashed #000000;" align="left" valign="bottom" class="font2" ><p><h1>
        <div id="wmy">Tambah Data Permohonan Reklame </div>
      </h1></p>
    ...
    <tr class="font3">
      <td align="right"  style="padding-left:10px ">Kategori Reklame</td>
      <td align="center"  class="text">:</td>
      <td align="left"><div align="left">
<input name="jnsrek" id="jnsrek" type="radio" value="1" checked> Reklame HO     
<input name="jnsrek" id="jnsrek" type="radio" value="2"> Reklame Non HO</div></td>
    </tr>
    <tr class="font3" id="RowHO">
      <td align="right"  style="padding-left:10px ">Pencarian Data HO</td>
      <td align="center"  class="text">:</td>
      <td align="left"><? echo form_input($cari);?><a href="#Mho" data-toggle="modal"><img src="../../assets/images/search.gif" width="16" height="16" align="Cari" title="Cari SIUP"></a>
      <input type="hidden" name="ho_id" id="ho_id"></td>
    </tr>
    <tr class="font3" >
...
Belum dibayar<br> <span class="text">Keterangan <? echo form_input($ketbayar);?></span>
    ...
    <tr align="right">
      <td height="25" colspan="3" style="padding:10px 0px 10px 0px; border-bottom:1px dashed #000000;" align="left" valign="bottom" class="font2" >6. Reklame</div></td>
    </tr>
...
<input type="hidden"  name="rokok_alkohol1" id="rokok_alkohol1">
    ...
    <tr align="right">
      <td><div align="left">
        <input type="button" name="Button2" value="Tambah Reklame" onClick="addDataReklame()">
      </div></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
...
<script language="javascript">
	...
	if (confirmSubmit())
		{
		document.kirim.action="<?=site_url()."/reklame/simpen_baru"?>";
