  ...
  <table width="100%"  border="0" cellspacing="1" cellpadding="1">
    <tr>
      <td height="25" colspan="3" style="padding:10px 0px 10px 0px; border-bottom:1px dashed #000000;" align="left" valign="bottom" class="font2" ><p><h1>
        <div id="wmy">Edit Data Permohonan IUJK 
          <input type="hidden" name="id" id="id" value="<?=$id?>">
          <input type="hidden" name="iujk_id" id="iujk_id">
    ...
    <tr class="font3">
      ...
      <td align="left" class="font3">
		<?
		 ...
		 $id_bidangjasa=$data_bidangjasa[2];
		 for($i=0;$i<$jml;$i++)
			{
		 ?>
		 <input type="checkbox" name="checkbox" value="<?=$id_bidangjasa[$i]?>"> 
		 <?
			echo $data[$i];
			echo "<br>";
			}
