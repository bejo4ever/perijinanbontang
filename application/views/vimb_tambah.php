...
function addRetribusi(counter1)
{
	...
	newDiv.html('<td align="center" bgcolor="#DCEEFF" class="text">'+
				...
				'</td>'+
          		...
          		'<td align="center" bgcolor="#DCEEFF"><span id="HRow'+counter1+'"><a href="javascript:hapusDataBangunan('+counter1+')"><img src="../../assets/images/b_drop.png" width="16" height="16"></a></span></td>');
  ...
  <table width="100%"  border="0" cellspacing="1" cellpadding="1">
    <tr>
      <td height="25" colspan="3" style="padding:10px 0px 10px 0px; border-bottom:1px dashed #000000;" align="left" valign="bottom" class="font2" ><p><h1>
        <div id="wmy">Tambah Data Permohonan IMB </div>
      </h1></p>
    ...
    <!--SIUP lama-->
    <tr class="font3" >
      <td width="26%" align="right" style="padding-left:10px ">Pembaharuan Ke- </td>
      <td width="1%" align="center" class="text">:</td>
...
<? echo form_input($hp1);?> </td>
    ...
    <tr>
      ...
      <td><div align="center">:</div></td>
      <td><span class="text"><input type="text" name="luasbangunan1" id="luasbangunan1" class="<?=$totaldatabangunan["class"]?>" onKeyUp="setKoefisien(1,'a',this.value,'')"> M <sup>2</sup> </span></td>
    </tr>
    <tr class="font3">
    ...
    <tr class="font3">
      ...
      <td align="center"  class="text">:</td>
      <td align="left">
	  <select name="kfungsi1" id="kfungsi1" onChange="setKoefisien(1,'d',this.value,'fsbangunan')"><?		
		reset($kfungsi1);
		for($i=0;$i<count($kfungsi1);$i++)
  			{
			?>
...
<span class="text"><? echo form_input($peruntukan);?></span>&nbsp;</td>
    ...
    <tr class="font3">
      ...
      <td align="center"  class="text">:</td>
      <td align="left" id="alamat1">
	  <select name="ktingkat1" id="ktingkat1" onChange="setKoefisien(1,'b',this.value,'indekstingkat')"><?		
		reset($ktingkat1);
		for($i=0;$i<count($ktingkat1);$i++)
  			{
			?>
    ...
    <tr class="font3">
      ...
      <td align="center"  class="text">:</td>
      <td align="left" id="tddesa1">
        <select name="kstruktur1" id="kstruktur1" onChange="setKoefisien(1,'e',this.value,'struktur')">
          <?		
		reset($kstruktur1);
		for($i=0;$i<count($kstruktur1);$i++)
  			{
        ...
        <input type="hidden" name="totaldatabangunan" id="totaldatabangunan" value="1"></td>
    </tr>
    <tr class="font3">
    ...
    <tr class="font3"  >
      <td colspan="3" align="right" style="padding-left:10px " ><div align="left">
        <input type="button" name="TambahDataBangunan" id="TambahDataBangunan" value="Tambah Data Bangunan" onclick="addDataBangunan()">
      </div></td>
    </tr>
    <tr class="font3"  >
    ...
    <tr>
      <td colspan="3" align="right"><table width="100%" id="tableRetribusi"  border="0" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF" style="border:1px solid #000 ">
        ...
        <tr valign="top" id="row1" >
          ...
          <td align="center" bgcolor="#DCEEFF">&nbsp;</td>
        </tr>
		</tbody>
        <tr valign="top" style="font-weight:bold ">
          ...
          <td align="center" valign="middle" bgcolor="#DCEEFF"><a href="javascript:addDataBangunan()"><img src="../../assets/images/add.gif" width="21" height="21" onClick="AddRow()" ></a></td>
        </tr>
      </table></td>
    </tr>
    <tr>
...
<script language="javascript">
	...
	if (Confirm2("Anda yakin data yang anda masukkan sudah benar ?"))
		{
		document.kirim.action="<?=site_url()."/imb/simpen_baru"?>";
