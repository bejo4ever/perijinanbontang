...
class C_t_apotek_det extends CI_Controller{
	...
	function create(){
		...
		$det_apotek_tanggal = htmlentities($this->input->post('det_apotek_tanggal'),ENT_QUOTES);
		...
		$det_apotek_sk = htmlentities($this->input->post('det_apotek_sk'),ENT_QUOTES);
		$det_apotek_baptanggal = htmlentities($this->input->post('det_apotek_baptanggal'),ENT_QUOTES);
		$det_apotek_berlaku = htmlentities($this->input->post('det_apotek_berlaku'),ENT_QUOTES);
		$det_apotek_kadaluarsa = htmlentities($this->input->post('det_apotek_kadaluarsa'),ENT_QUOTES);
		...
		if($apotek_det_author != ''){
			...
			if($resultInti != 0){
				...
				$data = array(
					...
					'det_apotek_tanggal'=>$det_apotek_tanggal,
					'det_apotek_kelengkapan'=>$det_apotek_kelengkapan,
					'det_apotek_bap'=>$det_apotek_bap,
					'det_apotek_sk'=>$det_apotek_sk,
					'det_apotek_baptanggal'=>$det_apotek_baptanggal,
					'det_apotek_berlaku'=>$det_apotek_berlaku,
					'det_apotek_kadaluarsa'=>$det_apotek_kadaluarsa,
