...
class Siup_model extends CI_Model {   
    ...
    {
		$sql	=   "SELECT t.id siup_id,p.pemohon_id pemohon_id,date_format(p.tglpermohonan,'%d-%m-%Y') as tglpermohonan,p.jpermohonan_id,t.counter_daftar,p.no_agenda,p.noregistrasi,perusahaan_id,t.klui,t.klui_pokok,t.no_menkeh,date_format(t.tgl_menkeh,'%d-%m-%Y') as tgl_menkeh,
	...
	$counter_daftar=$data["counter_daftar"];
	 ...
	 $sql="insert into siup(`permohonan_id`,`perusahaan_id`,`klui`,`klui_pokok`,`no_menkeh`,`tgl_menkeh`,
   ...
   '$no_aapad','$tgl_aapad','$no_lpad','$tgl_lpad','$counter_daftar')";
	...
	$sql="update siup set `perusahaan_id`='$perusahaan_id',
