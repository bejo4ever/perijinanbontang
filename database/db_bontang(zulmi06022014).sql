ALTER TABLE `sppl`
ADD COLUMN `TGL_BERLAKU`  date NULL DEFAULT NULL AFTER `TGL_PERMOHONAN`,
ADD COLUMN `TGL_BERAKHIR`  date NULL DEFAULT NULL AFTER `TGL_BERLAKU`,
ADD COLUMN `RETRIBUSI`  float NOT NULL DEFAULT NULL AFTER `TGL_BERAKHIR`;
