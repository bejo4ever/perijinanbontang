						...
						foreach($row->action_urls as $action_unique_id => $action_url){ 
							...
							?>
								<div style="display:none; position:absolute " id="status<?=$num_row?>" onmouseout="document.getElementById('status<?=$num_row?>').style.display='none'" >
                  					<div class="mnuaksi" style="width:135px " onmouseover="document.getElementById('status<?=$num_row?>').style.display=''"><a href="#">Selesai, belum diambil</a></div>
                  					<div class="mnuaksi" style="width:135px " onmouseover="document.getElementById('status<?=$num_row?>').style.display=''"><a href="#">Selesai, sudah diambil</a></div>
                  					<div class="mnuaksi" style="width:135px " onmouseover="document.getElementById('status<?=$num_row?>').style.display=''"><a href="#">Tolak Permohonan</a></div>
                				</div>
							<?
								}
							elseif ($action->label=="Cetak SK")
							...
							<div style="display:none; position:absolute " id="sk<?=$num_row?>" onMouseOut="document.getElementById('sk<?=$num_row?>').style.display='none'" >				
								<div class="mnuaksi" onMouseOver="document.getElementById('sk<?=$num_row?>').style.display=''"><a target="_blank" href="#">Cetak SK</a></div>
								<div class="mnuaksi" onMouseOver="document.getElementById('sk<?=$num_row?>').style.display=''"><a target="_blank" href="#">Cetak tanpa TTD</a></div>
							</div>
							<?
								}
							elseif ($action->label=="Cetak Tanda Bukti")
