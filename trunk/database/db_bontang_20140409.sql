...
Source Database       : db_bontang_0205

Target Server Type    : MYSQL
Target Server Version : 50611
File Encoding         : 65001

Date: 2014-04-09 21:35:55
*/
...
CREATE TABLE `ijin` (
  ...
  `NIP_PEJABAT` varchar(100) DEFAULT NULL,
  `JABATAN` varchar(100) DEFAULT NULL,
  `PANGKAT` varchar(100) DEFAULT NULL,
  `NAMA_REKOM` varchar(100) DEFAULT NULL,
  `NIP_REKOM` varchar(100) DEFAULT NULL,
  `JABATAN_REKOM` varchar(100) DEFAULT NULL,
  `PANGKAT_REKOM` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `iujkbidang` (
  ...
  `tahun_proyek` varchar(5) DEFAULT NULL,
  `nilai_proyek` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `iujkbidang_iujk` (`iujk_id`) USING BTREE,
  KEY `iujkbidung_bidang` (`bidangjasa_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3020 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
CREATE TABLE `m_perusahaan` (
  ...
  `perusahaan_npwp` varchar(100) DEFAULT NULL,
  `perusahaan_nama` varchar(100) DEFAULT NULL,
  `perusahaan_noakta` varchar(100) DEFAULT NULL,
  `perusahaan_notaris` varchar(100) DEFAULT NULL,
  `perusahaan_tglakta` date DEFAULT NULL,
  `perusahaan_bentuk_id` int(11) DEFAULT NULL,
  `perusahaan_kualifikasi_id` int(11) DEFAULT NULL,
  `perusahaan_alamat` varchar(100) DEFAULT NULL,
  `perusahaan_rt` varchar(10) DEFAULT NULL,
  `perusahaan_rw` varchar(10) DEFAULT NULL,
  `perusahaan_propinsi_id` int(11) DEFAULT NULL,
  `perusahaan_kabkota_id` int(11) DEFAULT NULL,
  `perusahaan_kecamatan_id` int(11) DEFAULT NULL,
  `perusahaan_desa_id` int(11) DEFAULT NULL,
  `perusahaan_kodepos` varchar(20) DEFAULT NULL,
  `perusahaan_telp` varchar(50) DEFAULT NULL,
  `perusahaan_fax` varchar(50) DEFAULT NULL,
  `perusahaan_stempat_id` int(11) DEFAULT NULL,
  `perusahaan_sperusahaan_id` int(11) DEFAULT NULL,
  `perusahaan_usaha` varchar(100) DEFAULT NULL,
  `perusahaan_butara` varchar(100) DEFAULT NULL,
  `perusahaan_bselatan` varchar(100) DEFAULT NULL,
  `perusahaan_btimur` varchar(100) DEFAULT NULL,
  `perusahaan_bbarat` varchar(100) DEFAULT NULL,
  `perusahaan_modal` varchar(50) DEFAULT NULL,
  `perusahaan_merk` int(4) DEFAULT NULL,
  `perusahaan_jusaha_id` int(11) DEFAULT NULL,
  `perusahaan_sdata` int(4) DEFAULT NULL,
...
CREATE TABLE `pemohon` (
  ...
  `stra` varchar(50) DEFAULT NULL,
  `surattugas` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=31757 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=31674 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=26795 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_apotek` (
  ...
  `apotek_perusahaan_id` int(11) DEFAULT NULL,
...
CREATE TABLE `t_apotek_det` (
  ...
  `det_apotek_nomorreg` varchar(50) DEFAULT NULL,
  `det_apotek_permohonan_id` int(11) DEFAULT NULL,
...
CREATE TABLE `t_idam` (
  ...
  `idam_perusahaan_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`idam_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_idam_det` (
  ...
  `det_idam_permohonan_id` int(11) DEFAULT NULL,
...
CREATE TABLE `t_ipmbl_det` (
  ...
  `det_ipmbl_permohonan_id` int(11) DEFAULT NULL,
...
CREATE TABLE `t_iujk` (
  ...
  `iujk_perusahaan_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`iujk_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_iujk_det` (
  ...
  `det_iujk_permohonan_id` int(11) DEFAULT NULL,
...
CREATE TABLE `t_iujt` (
  ...
  `iujt_perusahaan_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`iujt_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_iujt_det` (
  ...
  `det_iujt_permohonan_id` int(11) DEFAULT NULL,
...
CREATE TABLE `t_simb` (
  ...
  `simb_perusahaan_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`simb_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_simb_det` (
  ...
  `det_simb_permohonan_id` int(11) DEFAULT NULL,
...
CREATE TABLE `t_sipd` (
  ...
  `sipd_perusahaan_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`sipd_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_sipd_det` (
  ...
  `det_sipd_permohonan_id` int(11) DEFAULT NULL,
