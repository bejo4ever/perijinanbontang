<?php
class C_cek_list_lokasi extends CI_Controller{
	...
	function index(){
		$this->load->view('main/v_cek_list_lokasi');
	}
	...
	function getList(){
		...
		$result = $this->m_cek_list_lokasi->getList($params);
		echo $result;
	}
	...
	function create(){
		...
		if(!$k_list_lokasi_author){
			...
			$result = $this->m_cek_list_lokasi->__insert($data, '', '');
		}
		echo $result;
	}
	...
	function update(){
		...
		if(!$k_list_lokasi_updated_by){
			...
			$result = $this->m_cek_list_lokasi->__update($data, $ID_SYARATID_IJIN, '', '');
		}
		echo $result;
	}
	...
	function delete(){
		...
		$result = $this->m_cek_list_lokasi->__delete($arrayId,'');
		echo $result;
	}
	...
	function search(){
		...
		$result = $this->m_cek_list_lokasi->search($params);
		echo $result;
	}
	...
	function printExcel(){
		...
		if($outputType == 'PRINT'){
			$print_file=fopen('print/cek_list_lokasi_list.html','w+');
		}elseif($outputType == 'EXCEL'){
			$print_file=fopen('print/cek_list_lokasi_list.xls','w+');
		}
