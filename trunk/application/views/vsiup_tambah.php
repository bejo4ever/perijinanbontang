...
<link rel="stylesheet" href="../../assets/jQuery/ui/themes/base/jquery.ui.all.css">
	...
	function Tpilih(jenis,id)
		...
		{
		$.ajax({
            'url' : base_url + '/' + 'master/get_data_ho_siup/'+id,            
...
<fieldset>
  <table width="100%"  border="0" cellspacing="1" cellpadding="1">
    <tr>
      <td height="25" colspan="3" style="padding:10px 0px 10px 0px; border-bottom:1px dashed #000000;" align="left" valign="bottom" class="font2" ><p><h1><div id="wmy">Tambah Data Permohonan SIUP</div></h1></p>
    ...
    <tr class="font3" id="trskbaru">
      <td width="29%" align="right" style="padding-left:10px ">Pencarian Data HO </td>
      <td width="2%" align="center" class="text">:</td>
      <td width="71%" align="left">&nbsp;<a href="#Mho" data-toggle="modal"><img src="../../assets/images/search.gif" width="16" height="16" align="Cari" title="Cari SIUP"></a></td>
    </tr>
    <!--SIUP lama-->
    <tr class="font3">
...
<span class="text"><? echo form_input($alamat2);?></span>&nbsp;RT : <span class="text">&nbsp;<? echo form_input($rt2);?></span> </td>
    ...
    <tr class="font3"  >
      ...
      <td align="center"  class="text">:</td>
      <td align="left"  class="text"><? echo form_input($telp2);?> Fax : <? echo form_input($fax2);?> Kode Pos : <? echo form_input($kodepos2);?></td>
    </tr>
    <tr class="font3"  >
    ...
    <tr valign="top" class="font3" >
      ...
      <td align="left"><div>
        ...
        Sudah dibayar, tanggal        <a href="javascript:void(0)" onclick="if(self.gfPop)gfPop.fPopCalendar(document.getElementById('tglbayar'));return false;" hidefocus="HIDEFOCUS">  </a>
          ...
          <br><input name="sbayar" onchange="SetRetribusi(this)"  value="0"type="radio" />
Belum dibayar <br>
...
<script language="javascript">
	...
	if (confirmSubmit())
		{
		document.kirim.action="<?=site_url()."/siup/simpen_baru"?>";
