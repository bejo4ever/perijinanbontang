...
<body onLoad="window.print();">
	<table width="720px" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td colspan="2" align="center"><h3 style="margin:0px;"><u>IZIN LINGKUNGAN</u></h3></td>
		</tr>
		<tr>
			<td width="200px">&nbsp;</td>
			<td>&nbsp;</td>
		...
		<tr>
			...
			<td>: <?php echo $printrecord["PENANGGUNG_JAWAB"]; ?></td>
		</tr>
		<tr>
			<td>Nama Usaha</td>
			<td>: <?php echo $printrecord["NAMA_PERUSAHAAN"]; ?></td>
		</tr>
		<tr>
			<td>No Telepon</td>
