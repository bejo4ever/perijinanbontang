	...
	<table width="700" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td height="350" colspan="3" align="center" valign="middle"
				...
				<table width="78%" border="0" cellspacing="0" cellpadding="5">
					...
					<tr>
						<td><div align="left">
								<span class="style3">Alamat Pemohon </span>
							</div></td>
						<td>:</td>
						<td><div align="left">
						<?php echo $data_permohonan_list->alamat;?>
						<?php echo $this->String_model->IsEmpty($data_permohonan_list->rt)==false ? " RT ".$data_permohonan_list->rt : ""?>
						<?php echo $this->String_model->IsEmpty($data_permohonan_list->rw)==false ? " RW ".$data_permohonan_list->rw : ""?>
						<?php echo $data_permohonan_list->desa&&strtolower($data_permohonan_list->desa)!="lain-lain" ? " Kelurahan ".ucfirst(strtolower($data_permohonan_list->desa)) : ""?>
							</div></td>
					</tr>
					<tr>
						<td><div align="left">
		...
		<tr>
			<td height="64" colspan="3" align="center" valign="middle"
				...
				IJIN MENDIRIKAN BANGUNAN <br> (IMB) 
			...
			<td colspan="3" style="padding-left: 20px">
				<table width="100%" border="1" cellpadding="4" cellspacing="0"
					...
					<tr align="center" valign="middle">
						...
						<td rowspan="2" width="15%"><strong>Keterangan</strong></td>
					</tr>
					<tr align="center" valign="middle">
						<td width="25%"><strong>Instansi</strong></td>
...
<div id="printableArea">
	...
	<table width="700" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td height="106" colspan="3" align="center"><span
				style="color: #000000; font-family: 'Times New Roman', Times, serif; font-weight: bold; font-size: 24px">
			</span>
			</td>
			<td width="558" align="center"><p>
					<img src="../images/logo3.gif" width="50" height="60" /><br /> <span
						style="color: #000000; font-family: 'Times New Roman', Times, serif; font-weight: bold; font-size: 12px">BUKTI
						PENERIMAAN DOKUMEN IMB</span> <span class="style1"><br /> <span
						style="color: #000000; font-family: 'Times New Roman', Times, serif; font-weight: bold">
							BADAN PELAYANAN PERIJINAN TERPADU DAN PENANAMAN MODAL </span> </span><br />
					<span
						style="color: #000000; font-family: 'Times New Roman', Times, serif; font-size: 12px">
						Jl. MT. Haryono No.31 Telp. (0548) 20594 Fax. (0548) 20598 Kode
						Pos 75311 </span><br /> BONTANG
				</p>
			</td>
			<td width="40">&nbsp;</td>
			<td width="21">&nbsp;</td>
			...
			<td colspan="4"><table width="100%" border="0" cellspacing="0"
					...
					<tr valign="top">
						...
						<tr valign="top">
							...
							if (strtolower($data_permohonan_list->desa)!="lain-lain")
							$alamat	.= $data_permohonan_list->desa ? " Kel. ".ucwords(strtolower($data_permohonan_list->desa)) : "";
							if (strtolower($data_permohonan_list->kecamatan)!="lain-lain")
							$alamat	.= $data_permohonan_list->kecamatan ? ",Kec. ".ucwords(strtolower($data_permohonan_list->kecamatan )): "";
							echo $alamat;
							?>
							</td>
						</tr>
						...
						<tr valign="top">
							...
							<td align="center">:</td>
							<td><?php echo $this->Permohonan_cetak_model->get_tgl_selesai(1);?>&nbsp;</td>
						</tr>
		...
		<tr>
			<td colspan="6" align="right"><table width="169" border="0"
				...
				<p align="right">
					<?php echo $this->Permohonan_cetak_model->get_no_form(5); ?>
				</p>
			</td>
		</tr>
	</table>
