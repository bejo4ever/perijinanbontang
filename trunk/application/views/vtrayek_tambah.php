  ...
  <table width="100%"  border="0" cellspacing="1" cellpadding="1">
    <tr>
      <td height="25" colspan="3" style="padding:10px 0px 10px 0px; border-bottom:1px dashed #000000;" align="left" valign="bottom" class="font2" ><p><h1>
        <div id="wmy">Tambah Data Permohonan Trayek</div>
      </h1></p>
    ...
    <tr class="font3">
      ...
      <td align="center" class="text">:</td>
      <td align="left"><? echo form_input($no_sk);?></td>
    </tr>
    <tr class="font3">
...
<? echo form_input($hp1);?> </td>
    ...
    <tr class="font3">
      ...
      <td align="left" class="font3"><span class="text"><? echo form_input($npwp2);?></span>&nbsp;
        ...
        <input type="hidden" name="perusahaan_id" id="perusahaan_id2"></td>
    </tr>
    <tr class="font3">
...
<script language="javascript">
	...
	if (confirmSubmit())
		{
		document.kirim.action="<?=site_url()."/trayek/simpen_baru"?>";
