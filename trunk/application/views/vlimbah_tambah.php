  ...
  <table width="100%"  border="0" cellspacing="1" cellpadding="1">
    <tr>
      <td height="25" colspan="3" style="padding:10px 0px 10px 0px; border-bottom:1px dashed #000000;" align="left" valign="bottom" class="font2" ><p><h1>
        <div id="wmy">Tambah Data Permohonan Pembuangan Limbah Cair </div>
      </h1></p>
    ...
    <tr class="font3" >
      ...
      <td width="71%" align="left" ><? echo form_input($ktp1);?>&nbsp;
        <a href="#Mktp" data-toggle="modal"><img src="../../assets/images/search.gif" width="16" height="16" align="Cari" title="Cari data pemohon"></a>
...
<? echo form_input($hp1);?> </td>
    ...
    <tr class="font3">
      ...
      <td align="left" class="font3"><span class="text"><? echo form_input($npwp2);?></span>&nbsp;
        <a href="#Mperus" data-toggle="modal"><img src="../../assets/images/search.gif" width="16" height="16" align="Cari" title="Cari data perusahaan"></a>
    ...
    <tr valign="top" class="font3" >
      ...
      <td align="left"><div>
        ...
        Sudah dibayar, tanggal        <a href="javascript:void(0)" onclick="if(self.gfPop)gfPop.fPopCalendar(document.getElementById('tglbayar'));return false;" hidefocus="HIDEFOCUS">  </a>
          ...
          <br><input name="sbayar" onchange="SetRetribusi(this)"  value="0"type="radio" checked />Belum dibayar 
		  <br><input name="sbayar" onchange="SetRetribusi(this)"  value="2" type="radio"/>Gratis <br>
</div>          </td>
    </tr>
    <tr>
...
<script language="javascript">
	...
	if (confirmSubmit())
		{
		document.kirim.action="<?=site_url()."/limbah/simpen_baru"?>";
